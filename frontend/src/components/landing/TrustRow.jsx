...
export function TrustRow() {
  return (
    <section className="border-t border-line py-8">
      <ul className="mx-auto flex max-w-6xl flex-col flex-wrap items-center justify-center gap-x-8 gap-y-2 px-4 text-center text-sm text-muted sm:flex-row sm:px-6">
        {CLAIMS.map((claim) => (
